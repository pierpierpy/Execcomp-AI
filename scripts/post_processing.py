...
CLASSIFIER_MODEL_PATH = BASE_PATH / "hf/models/exp3-weighted-loss-qwen3-bigger_dataset/full"
...
def push_only():
    ...
    # Push to Hub - push entire DatasetDict at once to avoid metadata bug
